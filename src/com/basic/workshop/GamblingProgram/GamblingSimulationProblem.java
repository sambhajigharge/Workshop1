...
public class GamblingSimulationProblem {
    ...
    public static void main(String[] args) {
        int[] maxiNumWon = new int[100];
        int[] maxiNumLost = new int[100];
        int month = 1;
